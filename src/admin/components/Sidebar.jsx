...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 min-h-screen p-6 flex flex-col
                    bg-gradient-to-b from-green-900 to-green-700 text-white shadow-lg">
      <h2 className="text-2xl font-bold mb-8">Fashion Admin</h2>
